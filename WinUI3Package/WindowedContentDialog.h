...
namespace winrt::WinUI3Package::implementation
{
    struct WindowedContentDialog : WindowedContentDialogT<WindowedContentDialog>
    {
        ...
        winrt::Windows::Foundation::IAsyncOperation<winrt::Microsoft::UI::Xaml::Controls::ContentDialogResult> ShowAsync(
            winrt::Microsoft::UI::Xaml::Window parentWindow,
            winrt::WinUI3Package::UnderlayMode underlay
        );
        ~WindowedContentDialog();
    private:
        winrt::Microsoft::UI::Xaml::Window m_window;
        winrt::WinUI3Package::ModernStandardWindowContextMenu m_modernMenu{ m_window };
        ...
        winrt::Microsoft::UI::Xaml::FrameworkElement m_acrylicBackground{ nullptr };

        UnderlayElement m_underlayPopup{ nullptr };
        ...
        winrt::Windows::Foundation::IAsyncAction waitForPlaceholderLoaded();
        void syncThemeToParent(winrt::Microsoft::UI::Xaml::Window const& parent);
    };
}
