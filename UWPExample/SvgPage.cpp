...
namespace winrt::UWPExample::implementation
{
	...
	winrt::Windows::Foundation::Uri SvgPage::GetPngFromSvgUrl(winrt::hstring const& svgUrl)
	{
		std::wstring s{ svgUrl };
	...
	winrt::Windows::UI::Xaml::Media::ImageSource SvgPage::GetPngBitmapFromSvgUrl(winrt::hstring const& svgUrl)
	{
		return winrt::Windows::UI::Xaml::Media::Imaging::BitmapImage{ GetPngFromSvgUrl(svgUrl) };
	}

	winrt::Windows::UI::Xaml::Media::ImageSource SvgPage::GetSvgImageSourceFromString(winrt::hstring const& svgContent)
	{
		winrt::Windows::UI::Xaml::Media::Imaging::SvgImageSource source;
		if (svgContent.empty())
			return source;
