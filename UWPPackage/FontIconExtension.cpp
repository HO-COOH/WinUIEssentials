...
namespace winrt::UWPPackage::implementation
{
    ...
    winrt::Windows::UI::Xaml::Media::FontFamily FontIconExtension::FontFamily()
    {
        return m_fontFamily;
    }
    void FontIconExtension::FontFamily(winrt::Windows::UI::Xaml::Media::FontFamily value)
    {
        m_fontFamily = value;
    }
    ...
    winrt::Windows::UI::Xaml::Media::Brush FontIconExtension::Foreground()
    {
        return m_foreground;
    }
    void FontIconExtension::Foreground(winrt::Windows::UI::Xaml::Media::Brush value)
    {
        m_foreground = value;
    }
    ...
    {
        winrt::Windows::UI::Xaml::Controls::FontIcon fontIcon;
        fontIcon.Glyph(Glyph());
        fontIcon.FontFamily(FontFamily() ? FontFamily() : winrt::Windows::UI::Xaml::Media::FontFamily{ L"Segoe Fluent Icons,Segoe MDL2 Assets" });
