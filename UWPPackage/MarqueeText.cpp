...
{
    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::m_speedProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"Speed",
            winrt::xaml_typename<double>(),
            winrt::xaml_typename<UWPPackage::MarqueeText>(),
            winrt::Windows::UI::Xaml::PropertyMetadata{ winrt::box_value(32.), &MarqueeText::propertyChanged }
    );

    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::m_repeatBehaviorProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"RepeatBehavior",
    ...
    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::m_behaviorProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"Behavior",
            winrt::xaml_typename<UWPPackage::MarqueeBehavior>(),
            winrt::xaml_typename<UWPPackage::MarqueeText>(),
            winrt::Windows::UI::Xaml::PropertyMetadata{
                winrt::box_value(UWPPackage::MarqueeBehavior{}),
                &MarqueeText::behaviorPropertyChanged
            }
    );

    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::m_directionProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"Direction",
            winrt::xaml_typename<UWPPackage::MarqueeDirection>(),
            winrt::xaml_typename<UWPPackage::MarqueeText>(),
            winrt::Windows::UI::Xaml::PropertyMetadata{
                winrt::box_value(UWPPackage::MarqueeDirection::Left),
                &MarqueeText::directionPropertyChanged
            }
    );

    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::m_textProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"Text",
    ...
    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::m_pauseOnHoverProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"PauseOnHover",
            winrt::xaml_typename<winrt::hstring>(),
            winrt::xaml_typename<UWPPackage::MarqueeText>(),
    ...
    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::m_intervalSpaceProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"IntervalSpace",
            winrt::xaml_typename<double>(),
            winrt::xaml_typename<UWPPackage::MarqueeText>(),
    ...
    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::SpeedProperty()
    {
        return m_speedProperty;
    }

    winrt::Windows::UI::Xaml::Media::Animation::RepeatBehavior MarqueeText::RepeatBehavior()
    {
    ...
    void MarqueeText::RepeatBehavior(winrt::Windows::UI::Xaml::Media::Animation::RepeatBehavior value)
    {
        SetValue(m_repeatBehaviorProperty, winrt::box_value(value));
    }

    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::RepeatBehaviorProperty()
    {
        return m_repeatBehaviorProperty;
    }

    UWPPackage::MarqueeBehavior MarqueeText::Behavior()
    {
        return winrt::unbox_value<UWPPackage::MarqueeBehavior>(
            GetValue(m_behaviorProperty)
        );
    }

    void MarqueeText::Behavior(UWPPackage::MarqueeBehavior value)
    {
        SetValue(m_behaviorProperty, winrt::box_value(value));
    }

    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::BehaviorProperty()
    {
        return m_behaviorProperty;
    }

    UWPPackage::MarqueeDirection MarqueeText::Direction()
    {
        return winrt::unbox_value<UWPPackage::MarqueeDirection>(
            GetValue(m_directionProperty)
        );
    }

    void MarqueeText::Direction(UWPPackage::MarqueeDirection value)
    {
        SetValue(m_directionProperty, winrt::box_value(value));
    }

    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::DirectionProperty()
    {
    ...
    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::TextProperty()
    {
    ...
    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::PauseOnHoverProperty()
    {
    ...
    winrt::Windows::UI::Xaml::DependencyProperty MarqueeText::IntervalSpaceProperty()
    {
    ...
    void MarqueeText::propertyChanged(winrt::Windows::UI::Xaml::DependencyObject d, winrt::Windows::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
        if (auto control = d.try_as<UWPPackage::MarqueeText>())
        {
            winrt::get_self<MarqueeText>(control)->updateAnimation(true);
        }
    }

    void MarqueeText::behaviorPropertyChanged(winrt::Windows::UI::Xaml::DependencyObject d, winrt::Windows::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
        auto container = d.as<UWPPackage::MarqueeText>();
        if (!container)
            return;
    ...
    void MarqueeText::directionPropertyChanged(winrt::Windows::UI::Xaml::DependencyObject d, winrt::Windows::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
        auto container = d.as<UWPPackage::MarqueeText>();
        if (!container)
            return;
    ...
    void MarqueeText::pauseOnHoverChanged(winrt::Windows::UI::Xaml::DependencyObject d, winrt::Windows::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
        auto container = d.as<UWPPackage::MarqueeText>();
        if (!container)
            return;
    ...
    void MarqueeText::spaceIntervalChanged(winrt::Windows::UI::Xaml::DependencyObject d, winrt::Windows::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
        auto container = d.as<UWPPackage::MarqueeText>();
        if (!container)
            return;
    ...
    void MarqueeText::container_SizeChanged(winrt::Windows::Foundation::IInspectable sender, winrt::Windows::UI::Xaml::SizeChangedEventArgs const& e)
    {
        if (!marqueeContainer)
            return;
    ...
    constexpr std::wstring_view MarqueeText::getVisualStateName(MarqueeDirection direction)
    {
        switch (direction)
        {
        case winrt::UWPPackage::MarqueeDirection::Left: return LeftwardsVisualStateName;
        case winrt::UWPPackage::MarqueeDirection::Right: return RightwardsVisualStateName;
        case winrt::UWPPackage::MarqueeDirection::Up: return UpwardsVisualStateName;
        case winrt::UWPPackage::MarqueeDirection::Down: return DownwardsVisualStateName;
        }
    }
    ...
    constexpr std::wstring_view MarqueeText::getVisualStateName(MarqueeBehavior behavior)
    {
        switch (behavior)
        {
        case winrt::UWPPackage::MarqueeBehavior::Ticker: return TickerVisualStateName;
        case winrt::UWPPackage::MarqueeBehavior::Looping: return LoopingVisualStateName;
        case winrt::UWPPackage::MarqueeBehavior::Bouncing: return BouncingVisualStateName;
        }
    }
    ...
    winrt::Windows::UI::Xaml::Media::Animation::Storyboard MarqueeText::createStoryboard(
        double start,
        double end,
