...
namespace winrt::UWPPackage::implementation
{
    ...
    winrt::Windows::Foundation::Collections::IVector<winrt::Windows::UI::Xaml::Data::IValueConverter> ConverterGroup::Converters()
    {
        return m_converters;
    }

    void ConverterGroup::Converters(winrt::Windows::Foundation::Collections::IVector<winrt::Windows::UI::Xaml::Data::IValueConverter> value)
    {
        m_converters = value;
    }
