...
{
    winrt::Windows::UI::Xaml::DependencyProperty EqualPanel::s_horizontalSpacingProperty =
    ...
    winrt::Windows::UI::Xaml::DependencyProperty EqualPanel::s_verticalSpacingProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"VerticalSpacing",
            winrt::xaml_typename<double>(),
            winrt::xaml_typename<class_type>(),
    ...
    winrt::Windows::UI::Xaml::DependencyProperty EqualPanel::s_orientationProperty =
        winrt::Windows::UI::Xaml::DependencyProperty::Register(
            L"Orientation",
            winrt::xaml_typename<winrt::Windows::UI::Xaml::Controls::Orientation>(),
            winrt::xaml_typename<class_type>(),
            winrt::Windows::UI::Xaml::PropertyMetadata{
                winrt::box_value(winrt::Windows::UI::Xaml::Controls::Orientation::Horizontal),
    ...
    winrt::Windows::UI::Xaml::Controls::Orientation EqualPanel::Orientation()
    {
        return winrt::unbox_value<winrt::Windows::UI::Xaml::Controls::Orientation>(GetValue(s_orientationProperty));
    }
    void EqualPanel::Orientation(winrt::Windows::UI::Xaml::Controls::Orientation value)
    {
        SetValue(s_orientationProperty, winrt::box_value(value));
    }
    winrt::Windows::UI::Xaml::DependencyProperty EqualPanel::HorizontalSpacingProperty()
    {
        return s_horizontalSpacingProperty;
    }
    winrt::Windows::UI::Xaml::DependencyProperty EqualPanel::VerticalSpacingProperty()
    {
        return s_verticalSpacingProperty;
    }
    winrt::Windows::UI::Xaml::DependencyProperty EqualPanel::OrientationProperty()
    {
    ...
    winrt::Windows::Foundation::Size EqualPanel::MeasureOverride(winrt::Windows::Foundation::Size availableSize)
    {
        ...
        if (m_visibleItemsCount > 0)
        {
            ...
            if (Orientation() == winrt::Windows::UI::Xaml::Controls::Orientation::Horizontal)
            {
                //horizontal orientation
                if (HorizontalAlignment() != winrt::Windows::UI::Xaml::HorizontalAlignment::Stretch || std::isinf(availableSize.Width))
                {
            ...
            else
            {
                ...
                if (VerticalAlignment() != winrt::Windows::UI::Xaml::VerticalAlignment::Stretch || std::isinf(availableSize.Height))
                {
                    return winrt::Windows::Foundation::Size{
                        m_maxItemWidth,
    ...
    void EqualPanel::onHorizontalAlignmentChanged(winrt::Windows::UI::Xaml::DependencyObject const& sender, winrt::Windows::UI::Xaml::DependencyProperty const& horizontalAlignmentProperity)
    {
        InvalidateMeasure();
    }
}
