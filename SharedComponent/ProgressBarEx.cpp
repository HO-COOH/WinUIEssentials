...
namespace winrt::PackageRoot::implementation
{
	void ProgressBarEx::EnsureDependencyProperties()
	{
		...
		s_highColorProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
			L"HighColor",
		...
		s_baseColorProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
			L"BaseColor",
			winrt::xaml_typename<winrt::Windows::UI::Color>(),
			winrt::xaml_typename<class_type>(),
			winrt::WinUINamespace::UI::Xaml::PropertyMetadata{
		...
		s_percentProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
			L"Percent",
    ...
    {
        auto border = GetTemplateChild(L"RootBorder").as<winrt::WinUINamespace::UI::Xaml::Controls::Border>();
        m_compositor = winrt::WinUINamespace::UI::Xaml::Hosting::ElementCompositionPreview::GetElementVisual(border).Compositor();
        ...
        startPointAnimation.IterationBehavior(winrt::WinUINamespace::UI::Composition::AnimationIterationBehavior::Forever);
        ...
        winrt::WinUINamespace::UI::Xaml::Hosting::ElementCompositionPreview::SetElementChildVisual(border, m_spriteVisual);
    ...
    winrt::WinUINamespace::UI::Xaml::DependencyProperty ProgressBarEx::HighColorProperty()
    {
    ...
    winrt::WinUINamespace::UI::Xaml::DependencyProperty ProgressBarEx::BaseColorProperty()
    {
    ...
    winrt::WinUINamespace::UI::Xaml::DependencyProperty ProgressBarEx::PercentProperty()
    {
    ...
    winrt::WinUINamespace::UI::Xaml::DependencyProperty ProgressBarEx::ValueProperty()
    {
        return s_valueProperty;
    }

    void ProgressBarEx::onPercentPropertyChanged(winrt::WinUINamespace::UI::Xaml::DependencyObject const& d, winrt::WinUINamespace::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
