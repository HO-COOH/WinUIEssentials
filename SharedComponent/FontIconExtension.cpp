...
namespace winrt::PackageRoot::implementation
{
    ...
    winrt::WinUINamespace::UI::Xaml::Media::FontFamily FontIconExtension::FontFamily()
    {
        return m_fontFamily;
    }
    ...
    winrt::WinUINamespace::UI::Xaml::Media::Brush FontIconExtension::Foreground()
    {
        return m_foreground;
    }
    ...
    {
        winrt::WinUINamespace::UI::Xaml::Controls::FontIcon fontIcon;
        fontIcon.Glyph(Glyph());
        fontIcon.FontFamily(FontFamily() ? FontFamily() : winrt::WinUINamespace::UI::Xaml::Media::FontFamily{ L"Segoe Fluent Icons,Segoe MDL2 Assets" });
