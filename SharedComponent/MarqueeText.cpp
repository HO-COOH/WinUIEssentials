...
namespace winrt::PackageRoot::implementation
{
	void MarqueeText::EnsureDependencyProperties()
	{
		...
		m_speedProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
		    L"Speed",
		    winrt::xaml_typename<double>(),
		    winrt::xaml_typename<PackageRoot::MarqueeText>(),
		    winrt::WinUINamespace::UI::Xaml::PropertyMetadata{ winrt::box_value(32.), &MarqueeText::propertyChanged }
		);

		m_repeatBehaviorProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
		    L"RepeatBehavior",
		    winrt::xaml_typename<winrt::WinUINamespace::UI::Xaml::Media::Animation::RepeatBehavior>(),
		    winrt::xaml_typename<PackageRoot::MarqueeText>(),
		    winrt::WinUINamespace::UI::Xaml::PropertyMetadata{
		        winrt::box_value(winrt::WinUINamespace::UI::Xaml::Media::Animation::RepeatBehaviorHelper::Forever()),
		        &MarqueeText::propertyChanged
		    }
		);

		m_behaviorProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
		    L"Behavior",
		    winrt::xaml_typename<PackageRoot::MarqueeBehavior>(),
		    winrt::xaml_typename<PackageRoot::MarqueeText>(),
		    winrt::WinUINamespace::UI::Xaml::PropertyMetadata{
		        winrt::box_value(PackageRoot::MarqueeBehavior{}), 
                &MarqueeText::behaviorPropertyChanged
            }
		);

		m_directionProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
		    L"Direction",
		    winrt::xaml_typename<PackageRoot::MarqueeDirection>(),
		    winrt::xaml_typename<PackageRoot::MarqueeText>(),
		    winrt::WinUINamespace::UI::Xaml::PropertyMetadata{ 
                winrt::box_value(PackageRoot::MarqueeDirection::Left), 
                &MarqueeText::directionPropertyChanged 
            }
		);

		m_textProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
		    L"Text",
		...
		m_pauseOnHoverProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
		    L"PauseOnHover",
		    winrt::xaml_typename<winrt::hstring>(),
		    winrt::xaml_typename<PackageRoot::MarqueeText>(),
		    winrt::WinUINamespace::UI::Xaml::PropertyMetadata{
		...
		m_intervalSpaceProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
		    L"IntervalSpace",
		    winrt::xaml_typename<double>(),
		    winrt::xaml_typename<PackageRoot::MarqueeText>(),
		    winrt::WinUINamespace::UI::Xaml::PropertyMetadata{
    ...
    void MarqueeText::OnApplyTemplate()
    {
        ...
        winrt::WinUINamespace::UI::Xaml::VisualStateManager::GoToState(*this, getVisualStateName(Direction()), false);
        winrt::WinUINamespace::UI::Xaml::VisualStateManager::GoToState(*this, getVisualStateName(Behavior()), false);
    }
    ...
    winrt::WinUINamespace::UI::Xaml::DependencyProperty MarqueeText::SpeedProperty()
    {
        return m_speedProperty;
    }

    winrt::WinUINamespace::UI::Xaml::Media::Animation::RepeatBehavior MarqueeText::RepeatBehavior()
    {
        return winrt::unbox_value<winrt::WinUINamespace::UI::Xaml::Media::Animation::RepeatBehavior>(
            GetValue(m_repeatBehaviorProperty)
        );
    }

    void MarqueeText::RepeatBehavior(winrt::WinUINamespace::UI::Xaml::Media::Animation::RepeatBehavior value)
    {
        SetValue(m_repeatBehaviorProperty, winrt::box_value(value));
    }

    winrt::WinUINamespace::UI::Xaml::DependencyProperty MarqueeText::RepeatBehaviorProperty()
    {
        return m_repeatBehaviorProperty;
    }

    PackageRoot::MarqueeBehavior MarqueeText::Behavior()
    {
        return winrt::unbox_value<PackageRoot::MarqueeBehavior>(
            GetValue(m_behaviorProperty)
        );
    }

    void MarqueeText::Behavior(PackageRoot::MarqueeBehavior value)
    {
        SetValue(m_behaviorProperty, winrt::box_value(value));
    }

    winrt::WinUINamespace::UI::Xaml::DependencyProperty MarqueeText::BehaviorProperty()
    {
        return m_behaviorProperty;
    }

    PackageRoot::MarqueeDirection MarqueeText::Direction()
    {
        return winrt::unbox_value<PackageRoot::MarqueeDirection>(
            GetValue(m_directionProperty)
        );
    }

    void MarqueeText::Direction(PackageRoot::MarqueeDirection value)
    {
        SetValue(m_directionProperty, winrt::box_value(value));
    }

    winrt::WinUINamespace::UI::Xaml::DependencyProperty MarqueeText::DirectionProperty()
    {
    ...
    winrt::WinUINamespace::UI::Xaml::DependencyProperty MarqueeText::TextProperty()
    {
    ...
    winrt::WinUINamespace::UI::Xaml::DependencyProperty MarqueeText::PauseOnHoverProperty()
    {
    ...
    winrt::WinUINamespace::UI::Xaml::DependencyProperty MarqueeText::IntervalSpaceProperty()
    {
    ...
    void MarqueeText::behaviorPropertyChanged(winrt::WinUINamespace::UI::Xaml::DependencyObject d, winrt::WinUINamespace::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
        ...
        winrt::WinUINamespace::UI::Xaml::VisualStateManager::GoToState(container, getVisualStateName(newBehavior), true);
    ...
    void MarqueeText::directionPropertyChanged(winrt::WinUINamespace::UI::Xaml::DependencyObject d, winrt::WinUINamespace::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
        ...
        winrt::WinUINamespace::UI::Xaml::VisualStateManager::GoToState(container, getVisualStateName(newDirection), true);
    ...
    void MarqueeText::spaceIntervalChanged(winrt::WinUINamespace::UI::Xaml::DependencyObject d, winrt::WinUINamespace::UI::Xaml::DependencyPropertyChangedEventArgs const& e)
    {
        ...
        for (auto visualStateGroup : winrt::WinUINamespace::UI::Xaml::VisualStateManager::GetVisualStateGroups(control->rootGrid))
        {
            for (auto visualState : visualStateGroup.States())
            {
                if (visualState.Name() == LoopingVisualStateName)
                {
                    auto const setter = (*visualState.Setters().First()).as<winrt::WinUINamespace::UI::Xaml::Setter>();
                    auto const oldPadding = setter.Value().as<winrt::WinUINamespace::UI::Xaml::Thickness>();
                    setter.Value(winrt::box_value(winrt::WinUINamespace::UI::Xaml::ThicknessHelper::FromLengths(
                        oldPadding.Left,
                        oldPadding.Top,
                        winrt::unbox_value<double>(e.NewValue()),
                        oldPadding.Bottom
                    )));
                    winrt::WinUINamespace::UI::Xaml::VisualStateManager::GoToState(container, L"EmptyBehaviorState", true);
                    winrt::WinUINamespace::UI::Xaml::VisualStateManager::GoToState(container, LoopingVisualStateName, true);
    ...
    void MarqueeText::container_SizeChanged(winrt::Windows::Foundation::IInspectable sender, winrt::WinUINamespace::UI::Xaml::SizeChangedEventArgs const& e)
    {
        ...
        winrt::WinUINamespace::UI::Xaml::Media::RectangleGeometry rect;
    ...
    constexpr std::wstring_view MarqueeText::getVisualStateName(MarqueeDirection direction)
    {
        switch (direction)
        {
        case winrt::PackageRoot::MarqueeDirection::Left: return LeftwardsVisualStateName;
        case winrt::PackageRoot::MarqueeDirection::Right: return RightwardsVisualStateName;
        case winrt::PackageRoot::MarqueeDirection::Up: return UpwardsVisualStateName;
        case winrt::PackageRoot::MarqueeDirection::Down: return DownwardsVisualStateName;
        }
    }
    ...
    constexpr std::wstring_view MarqueeText::getVisualStateName(MarqueeBehavior behavior)
    {
        switch (behavior)
        {
        case winrt::PackageRoot::MarqueeBehavior::Ticker: return TickerVisualStateName;
        case winrt::PackageRoot::MarqueeBehavior::Looping: return LoopingVisualStateName;
        case winrt::PackageRoot::MarqueeBehavior::Bouncing: return BouncingVisualStateName;
        }
    }
    ...
    bool MarqueeText::updateAnimation(bool resume)
    {
        ...
        if (!isActive)
        {
            winrt::WinUINamespace::UI::Xaml::VisualStateManager::GoToState(*this, MarqueeStoppedState, false);
            return false;
        }
        ...
        {
            stopMarquee(resume);
            segment2.Visibility(winrt::WinUINamespace::UI::Xaml::Visibility::Collapsed);
            return false;
        }
        ...
        */
        ...
        segment2.Visibility(behavior == MarqueeBehavior::Looping ? winrt::WinUINamespace::UI::Xaml::Visibility::Visible : winrt::WinUINamespace::UI::Xaml::Visibility::Collapsed);
        ...
        winrt::WinUINamespace::UI::Xaml::VisualStateManager::GoToState(*this, MarqueeActiveState, true);
        marqueeStoryboard.Begin();
        if (resume)
        {
    ...
    winrt::WinUINamespace::UI::Xaml::Media::Animation::Storyboard MarqueeText::createStoryboard(
        double start,
        double end,
        winrt::Windows::Foundation::TimeSpan duration,
        std::wstring_view targetProperty)
    {
        winrt::WinUINamespace::UI::Xaml::Media::Animation::Storyboard storyboard;
        winrt::WinUINamespace::UI::Xaml::Media::Animation::DoubleAnimationUsingKeyFrames animation;
        winrt::WinUINamespace::UI::Xaml::Duration const d = winrt::WinUINamespace::UI::Xaml::DurationHelper::FromTimeSpan(duration);
        animation.Duration(d);
        //animation.RepeatBehavior(RepeatBehavior());
        //animation.AutoReverse(Behavior() == MarqueeBehavior::Bouncing);
        winrt::WinUINamespace::UI::Xaml::Media::Animation::LinearDoubleKeyFrame frame[2];
        frame[0].Value(start);
        frame[1].Value(end);
        ...
        winrt::WinUINamespace::UI::Xaml::Media::Animation::Storyboard::SetTarget(animation, marqueeTransform);
        winrt::WinUINamespace::UI::Xaml::Media::Animation::Storyboard::SetTargetProperty(animation, targetProperty);
        return storyboard;
    }
