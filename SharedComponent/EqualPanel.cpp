...
namespace winrt::PackageRoot::implementation
{
	void EqualPanel::EnsureDependencyProperties()
	{
		...
		s_horizontalSpacingProperty = winrt::WinUINamespace::UI::Xaml::DependencyProperty::Register(
		    ...
		    winrt::WinUINamespace::UI::Xaml::PropertyMetadata{ winrt::box_value(0.0) }
		);
    ...
    winrt::WinUINamespace::UI::Xaml::Controls::Orientation EqualPanel::Orientation()
    {
        return winrt::unbox_value<winrt::WinUINamespace::UI::Xaml::Controls::Orientation>(GetValue(s_orientationProperty));
    }
    void EqualPanel::Orientation(winrt::WinUINamespace::UI::Xaml::Controls::Orientation value)
    {
        SetValue(s_orientationProperty, winrt::box_value(value));
    }
    winrt::WinUINamespace::UI::Xaml::DependencyProperty EqualPanel::HorizontalSpacingProperty()
    {
        return s_horizontalSpacingProperty;
    }
    winrt::WinUINamespace::UI::Xaml::DependencyProperty EqualPanel::VerticalSpacingProperty()
    {
        return s_verticalSpacingProperty;
    }
    winrt::WinUINamespace::UI::Xaml::DependencyProperty EqualPanel::OrientationProperty()
    {
    ...
    winrt::Windows::Foundation::Size EqualPanel::MeasureOverride(winrt::Windows::Foundation::Size availableSize)
    {
        ...
        if (m_visibleItemsCount > 0)
        {
            ...
            if (Orientation() == winrt::WinUINamespace::UI::Xaml::Controls::Orientation::Horizontal)
            {
                ...
                if (HorizontalAlignment() != winrt::WinUINamespace::UI::Xaml::HorizontalAlignment::Stretch || std::isinf(availableSize.Width))
                {
            ...
            else
            {
                ...
                if (VerticalAlignment() != winrt::WinUINamespace::UI::Xaml::VerticalAlignment::Stretch || std::isinf(availableSize.Height))
                {
                    return winrt::Windows::Foundation::Size{
                        m_maxItemWidth,
    ...
    void EqualPanel::onHorizontalAlignmentChanged(winrt::WinUINamespace::UI::Xaml::DependencyObject const& sender, winrt::WinUINamespace::UI::Xaml::DependencyProperty const& horizontalAlignmentProperity)
    {
        InvalidateMeasure();
    }
}
