...
namespace winrt::WinUI3Example::implementation
{
	void PlaygroundPage::InitializeComponent()
	{
		...
		XamlString().Editor().SetText(LR"(<essential:WindowEx 
		...
		winrt::Microsoft::UI::Xaml::RoutedEventArgs const&)
	{
		...
		try
		{
			...
			switch (RootKind().SelectedIndex())
			{
				case 0:
				{
                    obj.as<winrt::Microsoft::UI::Xaml::Window>().Activate();
					break;
				}
                case 1:
                {
					obj.as<winrt::WinUI3Package::WindowEx>().Activate();
                    break;
                }
                case 2:
                {
                    auto contentDialog = obj.as<winrt::Microsoft::UI::Xaml::Controls::ContentDialog>();
                ...
                case 3:
                {
                    obj.as<winrt::WinUI3Package::WindowedContentDialog>().ShowAsync(App::AppInstance->window.Window());
                    break;
                }
				default:
					break;
