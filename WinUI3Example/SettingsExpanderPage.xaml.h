...
namespace winrt::WinUI3Example::implementation
{
    ...
    private:
        std::vector<winrt::Windows::Foundation::IInspectable> m_myDataSet
        {
            ...
            winrt::make<MyDataModel>(
                L"Second Item",
				L"More about second item.",
				L"Item type: Link button",
				L"Click here for more on second item.",
				L"https://xbox.com/"
            ),
            winrt::make<MyDataModel>(
                L"Third Item",
                L"More about third item.",
                L"Item type: No button",
                L"Click here for more on third item.",
                L"https://toolkitlabs.dev/"
            )
        };
    public:
